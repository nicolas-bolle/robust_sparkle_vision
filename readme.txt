For a quick demo, run the demo_MNIST, demo_CIFAR, or demo_veggies scripts in the Code folder. See the write-up pdf for details on the algorithm and results of the numerics, or the presentation pdf for an overview.
